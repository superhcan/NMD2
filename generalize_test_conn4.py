"""
generalize_test_conn4.py — Kumulativ MMU-generalisering med skyddade klasser.

Skyddade klasser (53=väg, 61=sjö, 62=vatten) maskeras som nodata innan gdal_sieve
kör, och återställs efteråt. Konnektivitet: 4 (endast ortogonala grannar, jämnare kanter).
...
OUT_DIR = Path("/home/hcn/NMD_workspace/NMD2023_basskikt_v2_0/generalized_test_conn4")
...
for mmu in MMU_STEPS:
    t0      = time.time()
    outname = f"NMD2023bas_tile_r000_c010_conn4_mmu{mmu:03d}.tif"
